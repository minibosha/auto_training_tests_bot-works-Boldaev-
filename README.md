...
Как пользоваться: в таблице указана команда и её аттрибуты. Аттрибуты вводятся через пробел после команды в порядке
указанном в таблице. Например: /start; /start_test math 1; /an 1 -0-4.
